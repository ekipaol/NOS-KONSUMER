...
public class DataMmqTanah {
    ...
    @SerializedName("Luas_Aset")
    @Expose
    private Double luasAset;
    @SerializedName("Harga_Aset")
    @Expose
    private Double hargaAset;
    ...
    public Double getLuasAset() {
        return luasAset;
    }

    public void setLuasAset(Double luasAset) {
        this.luasAset = luasAset;
    }

    public Double getHargaAset() {
        return hargaAset;
    }

    public void setHargaAset(Double hargaAset) {
