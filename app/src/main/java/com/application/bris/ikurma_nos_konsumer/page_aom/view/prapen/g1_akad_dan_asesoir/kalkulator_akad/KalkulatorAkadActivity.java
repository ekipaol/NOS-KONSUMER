package com.application.bris.ikurma_nos_konsumer.page_aom.view.prapen.g1_akad_dan_asesoir.kalkulator_akad;
...
import com.application.bris.ikurma_nos_konsumer.databinding.ActivityKalkulatorAkadBinding;
...
public class KalkulatorAkadActivity extends AppCompatActivity implements GenericListenerOnSelect, View.OnClickListener, ConfirmListener {
    private ActivityKalkulatorAkadBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityKalkulatorAkadBinding.inflate(getLayoutInflater());
        ...
        calli.enqueue(new Callback<MParseArray>() {
            ...
            public void onResponse(@NonNull Call<MParseArray> call, @NonNull Response<MParseArray> response) {
                if (response.isSuccessful()) {
                    ...
                    AppUtil.notiferror(KalkulatorAkadActivity.this, findViewById(android.R.id.content), getString(R.string.txt_connection_failure));
                }
            }
    ...
    private void onClickEndIcon() {
        binding.tfPilihanasuransipenjaminan.getEndIconImageButton().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DialogGenericDataFromService.display(getSupportFragmentManager(), binding.tfPilihanasuransipenjaminan.getLabelText(), dataAsuransi, KalkulatorAkadActivity.this);
            }
        });
        binding.tfTreatmentBiayaAsuransi.getEndIconImageButton().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DialogGenericDataFromService.display(getSupportFragmentManager(), binding.tfTreatmentBiayaAsuransi.getLabelText(), dataDropdownKalkulator, KalkulatorAkadActivity.this);
            }
        });
        binding.tfTreatmentBiayaAsuransiKhusus.getEndIconImageButton().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DialogGenericDataFromService.display(getSupportFragmentManager(), binding.tfTreatmentBiayaAsuransiKhusus.getLabelText(), dataDropdownKalkulator, KalkulatorAkadActivity.this);
            }
        });
        binding.tfTreatmentBiayaAdministrasi.getEndIconImageButton().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DialogGenericDataFromService.display(getSupportFragmentManager(), binding.tfTreatmentBiayaAdministrasi.getLabelText(), dataDropdownKalkulator, KalkulatorAkadActivity.this);
            }
        });
        binding.tfTreatmentBiayaPenalti.getEndIconImageButton().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DialogGenericDataFromService.display(getSupportFragmentManager(), binding.tfTreatmentBiayaPenalti.getLabelText(), dataDropdownKalkulator, KalkulatorAkadActivity.this);
            }
        });
        binding.tfTreatmentBiayaMaterai.getEndIconImageButton().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DialogGenericDataFromService.display(getSupportFragmentManager(), binding.tfTreatmentBiayaMaterai.getLabelText(), dataDropdownKalkulator, KalkulatorAkadActivity.this);
            }
        });
    }
        ...
        switch (view.getId()) {
            ...
            case R.id.ll_btn_send:
                if (hitung != null)
                    ...
                    AppUtil.notiferror(KalkulatorAkadActivity.this, findViewById(android.R.id.content), "Klik Button Hitung Terlebih dahulu");
                break;
            //Button Hitung
...
//                        finish();
                        CustomDialog.DialogSuccess(KalkulatorAkadActivity.this, "Success!", "Update Data Kalkulator sukses", KalkulatorAkadActivity.this);
                        ...
                        AppUtil.notiferror(KalkulatorAkadActivity.this, findViewById(android.R.id.content), response.body().getMessage());
                    }
                }
            }
        ...
        call.enqueue(new Callback<ParseResponseAgunan>() {
            ...
            public void onResponse(Call<ParseResponseAgunan> call, Response<ParseResponseAgunan> response) {
                ...
                if (response.isSuccessful()) {
                    binding.loading.progressbarLoading.setVisibility(View.GONE);
                    if (response.body().getStatus().equalsIgnoreCase("00") && response.body().getData() != null) {
                        AppUtil.notifsuccess(KalkulatorAkadActivity.this, findViewById(android.R.id.content), "Berhasil Menghitung Kalkulator");
...
//                                binding.etBiayamaterai.setText(String.valueOf(DPSimulasiBiayaBiaya.getBiayaMaterai()));
            ...
            public void onFailure(Call<ParseResponseAgunan> call, Throwable t) {
                binding.loading.progressbarLoading.setVisibility(View.GONE);
                AppUtil.notiferror(KalkulatorAkadActivity.this, findViewById(android.R.id.content), t.getMessage());
            }
        });
    }
