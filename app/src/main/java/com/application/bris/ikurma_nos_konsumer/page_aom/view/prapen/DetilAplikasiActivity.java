...
import com.application.bris.ikurma_nos_konsumer.page_aom.view.prapen.d4_verifikasi_otor.verif_akseptasi_pendapatan.ActivityVerifAkseptasiPendapatan;
...
//            loadDetailAplikasi();
    ...
    public void onMenuClick(String menu) {
        ...
        //D4-D5-D6
            ...
            Intent it = new Intent(this, ActivityVerifAkseptasiPendapatan.class);
            it.putExtra("idAplikasi",idAplikasi);
            startActivity(it);
        }
