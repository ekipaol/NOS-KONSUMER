...
public class Menu {
    ...
    public static void SubmenuD1(Context context, List<ListViewSubmenuHotprospek> menu){
        ...
        menu.add(new ListViewSubmenuHotprospek(R.drawable.ic_history_nasabah,context.getString(R.string.submenu_detil_aplikasi_d1_data_dedupe)));
        menu.add(new ListViewSubmenuHotprospek(R.drawable.ic_ideb,context.getString(R.string.submenu_detil_aplikasi_d1_data_nasabah)));
