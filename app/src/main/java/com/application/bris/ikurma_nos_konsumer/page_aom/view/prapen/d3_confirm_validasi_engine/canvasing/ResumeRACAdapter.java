...
public class ResumeRACAdapter extends RecyclerView.Adapter<ResumeRACAdapter.MenuViewHolder> {

    private List<MparseResponseRAC> data;
    private Context context;
    private ItemHasilCanvasingBinding binding;
    private AppPreferences appPreferences;

    public ResumeRACAdapter(Context context, List<MparseResponseRAC> mdata) {
    ...
    public void onBindViewHolder(@NonNull MenuViewHolder holder, int position) {
        ...
        final MparseResponseRAC datas = data.get(position);
