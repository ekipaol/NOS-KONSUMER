...
public class UpdateDataPendapatan {
    ...
    @SerializedName("AplikasiPendapatan")
    @Expose
    private String AplikasiPendapatan;
    ...
    public String getAplikasiPendapatan() {
        return AplikasiPendapatan;
    }

    public void setAplikasiPendapatan(String aplikasiPendapatan) {
        AplikasiPendapatan = aplikasiPendapatan;
    }
}
